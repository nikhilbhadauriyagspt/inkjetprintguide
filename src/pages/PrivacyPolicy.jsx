...
export default function PrivacyPolicy() {
  return (
    ...
    >
      ...
      <p>To exercise these rights, you can contact us by submitting a data subject access request, by emailing us at <a href="mailto:info@printsphere.co">info@printsphere.co</a>, by visiting <a href="http://printsphere.co/contact">http://printsphere.co/contact</a>, or by referring to the contact details at the bottom of this document.</p>
