...
export default function ReturnPolicy() {
  return (
    ...
    >
      ...
      <p>
        To return an item, please email customer service at <a href="mailto:info@inkjetprintguide.co">info@inkjetprintguide.co</a> to obtain an Return Merchandise Authorization (RMA) number.
      </p>
