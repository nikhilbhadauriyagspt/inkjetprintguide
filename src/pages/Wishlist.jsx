  ...
  if (wishlistCount === 0) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6 bg-[#f8faff] font-sans text-center">
        ...
        <Link to="/shop" className="px-10 py-4 bg-[#2f5cab] text-white font-bold rounded-full shadow-xl shadow-[#0096d6]/20 active:scale-95 hover:bg-[#234d98] transition-all">
          Explore Products
        </Link>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#f8faff] font-sans text-slate-900 pb-20">
      ...
      <div className="bg-white py-12 md:py-16 border-b border-slate-100 mb-12">
        <div className="max-w-[1800px] mx-auto px-4 md:px-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-4">
            <nav className="flex items-center gap-2 text-[11px] font-bold text-slate-400  tracking-widest">
      ...
      <div className="max-w-[1800px] mx-auto px-4 md:px-10">
          ...
          <AnimatePresence>
            {wishlist.map((p) => (
              <m.div
                ...
                className="group flex flex-col bg-white rounded-[32px] p-4 border border-slate-100 hover:shadow-2xl hover:shadow-[#0096d6]/5 transition-all duration-500"
              >
                {/* Image Container */}
                ...
                <div className="px-2 flex-1 flex flex-col">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-[10px] font-bold text-[#2f5cab]  tracking-widest bg-blue-50 px-3 py-1 rounded-full">{p.brand_name || 'Printer'}</span>
                  ...
                  <div className="mt-auto pt-4 flex flex-col gap-4">
                    ...
                    <button
                      onClick={() => addToCart(p)}
                      className="w-full h-12 bg-[#2f5cab] text-white rounded-2xl flex items-center justify-center gap-3 text-[13px] font-bold  tracking-widest hover:bg-[#234d98] transition-all shadow-lg shadow-[#0096d6]/10 active:scale-95"
                    >
        ...
        <div className="mt-20 pt-10 border-t border-slate-100">
          <Link to="/shop" className="inline-flex items-center gap-3 text-[14px] font-bold text-slate-400 hover:text-[#2f5cab] transition-all group  tracking-widest">
