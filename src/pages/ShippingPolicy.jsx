...
export default function ShippingPolicy() {
  return (
    ...
    >
      <p className="lead">
        This Shipping & Delivery Policy is part of our Terms and Conditions ("Terms") and should be therefore read alongside our main Terms: <Link to="/terms-and-conditions">https://inkjetprintguide.co/terms-and-conditions</Link>.
      </p>
      <p>
      ...
      <div className="bg-gray-50 p-8 rounded-sm border border-border mt-6 not-prose">
        <h4 className="text-lg font-extrabold text-black mb-2  ">Free Shipping</h4>
        <p className="text-gray-500 font-bold m-0 ">We offer free Standard shipping on all orders.</p>
      </div>
      ...
      <p>
        If you have questions about returns, please review our Return Policy: <Link to="/return-policy">https://inkjetprintguide.co/return-policy</Link>.
      </p>
