              ...
              {loading ? (
                <tr>
                  <td colSpan="5" className="py-20 text-center">
                    <Loader2 className="animate-spin h-8 w-8 text-[#991B1B] mx-auto mb-4" />
                ...
                <tr key={contact.id} className="hover:bg-gray-50/50 transition-colors group">
                  ...
                  <td className="px-8 py-6">
                    <span className={`px-3 py-1 rounded-full text-[9px] font-bold capitalize tracking-widest border ${contact.status === 'new' ? 'bg-blue-50 text-[#991B1B] border-blue-100' :
            ...
            >
              <div className="flex items-center justify-between mb-10 pb-6 border-b border-gray-100">
                <div className="flex items-center gap-4">
                  <div className="h-14 w-14 rounded-2xl bg-blue-50 text-[#991B1B] flex items-center justify-center">
                    <MessageCircle size={28} />
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold text-slate-900 capitalize ">Inquiry Detail.</h2>
                    <p className="text-[10px] font-bold text-[#991B1B] capitalize tracking-widest mt-1">Status: {selectedContact.status}</p>
                  </div>
                </div>
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-100">
                <button
                  ...
                  className="flex-1 h-14 bg-[#991B1B] text-white rounded-2xl flex items-center justify-center gap-3 text-[10px] font-bold capitalize tracking-widest hover:bg-black transition-all shadow-xl shadow-blue-600/20"
                >
                  <CheckCircle size={16} /> Mark as Replied
                </button>
                <a
                  href={`mailto:${selectedContact.email}`}
                  className="flex-1 h-14 bg-slate-900 text-white rounded-2xl flex items-center justify-center gap-3 text-[10px] font-bold capitalize tracking-widest hover:bg-[#991B1B] transition-all shadow-xl"
                >
