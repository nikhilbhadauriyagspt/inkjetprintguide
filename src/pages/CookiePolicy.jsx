...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This Cookie Policy explains how Inklivo LLC ("Company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://inklivo.shop/">https://inklivo.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@inklivo.shop">info@inklivo.shop</a></li>
        <li>Visiting: <Link to="/contact">https://inklivo.shop/contact</Link></li>
      </ul>
      ...
      <div className="bg-gray-50 p-8 rounded-sm border border-[#e9e9e9] my-8 not-prose">
        <address className="not- text-gray-700 font-bold leading-relaxed space-y-2">
          ...
          <p className="pt-4 flex items-center gap-3 text-[#1447E6] font-extrabold">info@inklivo.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
