  ...
  return (
    ...
    >
      <section>
        ...
        <p>
          We are Printingmania LLC ("Company," "we," "us," "our"), a company registered in California, United States at 44110 Ashburn Village Blvd, Ashburn, VA 20147, USA.

        </p>
        <p>
          We operate the website <a href="http://printingmania.shop/">http://printingmania.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>
          Printingmania Solutions provides a wide range of high-performance printers and printing accessories from leading technology brands.
        </p>
        <p>
          You can contact us by email at <a href="mailto:info@printingmania.shop">info@printingmania.shop</a>, or by mail to 44110 Ashburn Village Blvd, Ashburn, VA 20147, USA.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Printingmania LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: <a href="mailto:info@printingmania.shop">info@printingmania.shop</a>. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.
        </p>
        <p>
      ...
      <section>
        ...
        <p>
          Please review our Return Policy prior to making any purchases: <a href="http://printingmania.shop/return-policy">http://printingmania.shop/return-policy</a>.
        </p>
      </section>
      ...
      <section>
        ...
        <div className="bg-gray-50 p-8 rounded-sm border border-border my-8 not-prose">
          <address className="not-italic text-gray-700 font-bold leading-relaxed space-y-2 capitalize ">
            <p className="text-black font-extrabold">Printingmania LLC</p>
            <p>Direct Distribution</p>
            <p>44110 Ashburn Village Blvd, Ashburn, VA 20147, USA</p>
            <p>United States</p>
            <p className="pt-4 text-primary font-extrabold lowercase">Email: info@printingmania.shop</p>
          </address>
        </div>
      </section>
    </PolicyLayout>
