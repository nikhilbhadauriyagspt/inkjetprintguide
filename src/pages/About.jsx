...
export default function About() {
  const categories = [
    {
      ...
      icon: <Printer size={24} className="text-[#4254e8]" />
    },
    {
      ...
      icon: <Droplets size={24} className="text-[#4254e8]" />
    },
    {
      ...
      icon: <Layers size={24} className="text-[#4254e8]" />
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white font-sans text-slate-900">
      <SEO title="About Inkjet Print Guide | A New Vision for Printing" />
        ...
        <div className="max-w-[1600px] mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
            <div className="space-y-4">
              ...
              <div className="w-12 h-1 bg-[#4254e8]"></div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {categories.map((item, i) => (
              <div key={i} className="group p-8 border border-slate-100 hover:border-[#4254e8] transition-all duration-500">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {steps.map((step, i) => (
              <div key={i} className="bg-white p-6 md:p-10 border border-slate-200 text-center relative group">
                <div className="absolute top-4 right-4 text-xs font-black text-slate-100 group-hover:text-[#4254e8]/10 transition-colors">0{i + 1}</div>
                <div className="inline-flex w-12 h-12 items-center justify-center text-[#4254e8] mb-4">
                  {step.icon}
                </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-6 text-slate-600 text-base md:text-lg leading-relaxed ">
                <p>
                  Inkjet Print Guide started with a simple observation: finding the right printing hardware should be straightforward, not complicated. We are a new team with a fresh perspective on how professional tools should be delivered.
                </p>
                <p>
              ...
              <div className="pt-4">
                <Link to="/contact" className="inline-flex items-center gap-3 text-[#4254e8] font-bol capitalized text-xs tracking-widest hover:gap-5 transition-all">
      ...
      <section className="py-20 md:py-28 bg-slate-900 text-white overflow-hidden relative">
        <div className="max-w-[1600px] mx-auto px-4 md:px-8 relative z-10 text-center space-y-8">
          ...
          <div className="pt-4">
            <Link to="/shop" className="inline-flex items-center gap-4 bg-[#4254e8] text-white px-10 py-5 font-bol capitalized text-[11px] tracking-[0.3em] hover:bg-white hover:text-black transition-all">
