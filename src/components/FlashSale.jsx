        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold text-slate-900  capitalize leading-none">
              Flash <span className="text-slate-400 ">Sale.</span>
            </h2>
          </div>
        </div>
        <Link to="/deals" className="text-xs font-bold capitalize tracking-widest text-slate-900 flex items-center gap-2 hover:text-[#F54900] transition-colors pb-1">
            ...
            >
              <div className="w-1/2 p-8 lg:p-12">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 text-xs font-bold capitalize tracking-widest transition-all ${addedItems[deal.id] ? 'text-emerald-500' : 'text-[#F54900] group-hover:gap-4'}`}
                >
                  {addedItems[deal.id] ? (
                    <><Check size={16} /> Added</>
                  ) : (
