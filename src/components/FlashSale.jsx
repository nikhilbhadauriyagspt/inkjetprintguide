  ...
  return (
    <section className="px-6 md:px-10 lg:px-12 py-16 bg-white font-urbanist">
      ...
      <div className="flex items-end justify-between mb-12 border-b border-gray-100 pb-8">
        ...
        <Link to="/deals" className="text-xs font-bold capitalize tracking-widest text-slate-900 flex items-center gap-2 hover:text-[#991B1B] transition-colors pb-1">
            ...
            >
              <div className="w-1/2 p-8 lg:p-12">
                ...
                <button
                  ...
                  className={`flex items-center gap-2 text-xs font-bold capitalize tracking-widest transition-all ${addedItems[deal.id] ? 'text-emerald-500' : 'text-[#991B1B] group-hover:gap-4'}`}
                >
                  {addedItems[deal.id] ? (
                    <><Check size={16} /> Added</>
                  ) : (
