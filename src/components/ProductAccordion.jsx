  ...
  return (
    <section className="py-16 md:py-24 bg-white font-sans border-t border-slate-100">
      <div className="w-full mx-auto px-6 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="h-px w-8 bg-[#F54900] rounded-full" />
          ...
          {displayProducts.map((p, i) => (
            ...
            >
              ...
              <div className="aspect-square w-full mb-8 relative">
                ...
                <button
                  onClick={() => addToCart(p)}
                  className="absolute bottom-0 right-0 h-12 w-12 rounded-full bg-[#F54900] text-white flex items-center justify-center translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300 hover:bg-slate-900"
                >
                  <Plus size={24} />
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <div className="h-1.5 w-1.5 rounded-full bg-slate-200 group-hover:bg-[#F54900] transition-colors" />
                </div>
              </div>
        ...
        {/* --- BOTTOM QUOTE BANNER --- */}
        <div className="mt-12 bg-[#F54900] rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden group hover:bg-[#006699] transition-all duration-500">
