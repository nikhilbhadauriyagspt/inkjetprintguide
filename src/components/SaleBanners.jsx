    ...
    <section className="w-full py-6 md:py-8 bg-white font-['Heebo']">
      <div className="max-w-full mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <Link to="/shop?category=laser-printers" className="relative overflow-hidden bg-[#10b981] p-8 md:p-10 min-h-[260px] flex flex-col justify-center group rounded-[2rem] transition-all duration-500">
          ...
          <Link to="/shop?category=all-in-one-printers" className="relative overflow-hidden bg-[#0f172a] p-8 md:p-10 min-h-[260px] flex flex-col justify-center group rounded-[2rem] transition-all duration-500">
            ...
            <div className="relative z-10">
              ...
              <div className="inline-flex items-center gap-2 text-[#10b981] font-black text-xs uppercase tracking-widest transition-all">
