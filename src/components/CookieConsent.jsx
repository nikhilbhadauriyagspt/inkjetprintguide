              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 md:px-10 md:py-8">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                  ...
                  <button
                    ...
                    className="flex-1 md:flex-none h-[48px] px-8 rounded-full bg-[#05718A] text-white text-[14px] font-bold hover:bg-[#045d72] transition-all shadow-lg shadow-[#05718A]/20"
                  >
                    Accept All
                  </button>
                  <button 
