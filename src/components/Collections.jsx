      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
        <div className="space-y-3">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-[#991B1B] capitalize tracking-[0.4em]">Core Pillars</span>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-2xl bg-white/80 backdrop-blur-md flex items-center justify-center shadow-sm">
                  <Laptop size={20} className="text-[#991B1B]" />
                </div>
              ...
              <h3 className="text-4xl md:text-6xl font-bold text-slate-950 capitalize  leading-none">
                Elite <br /><span className="text-[#991B1B] ">Laptops.</span>
              </h3>
              ...
              <Link to="/shop?category=laptop-computers" className="inline-flex items-center gap-4 h-14 px-8 bg-slate-950 text-white rounded-2xl font-bold text-[10px] capitalize tracking-[0.2em] hover:bg-[#991B1B] hover:scale-105 transition-all shadow-xl shadow-black/10">
